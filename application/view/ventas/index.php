  ...
  <table class="table table-hover">
      ...
      <?php foreach ($ven as $venta):?>
          <tr>
              ...
              <td><?php if (isset($venta->cliente)) echo htmlspecialchars($venta->cliente, ENT_QUOTES, 'UTF-8'); ?></td>
              <td><?php if (isset($venta->usuario)) echo htmlspecialchars($venta->usuario, ENT_QUOTES, 'UTF-8'); ?></td>
