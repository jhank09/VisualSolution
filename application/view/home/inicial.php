...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="<?php echo URL; ?>css/sl-slide.css">
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse pull-right">
                        <ul class="nav">
                            ...
                            <li class="nav-item dropdown nav navbar-nav navbar-right ml-auto">
                                <a data-toggle="dropdown" class="nav-link dropdown-toggle" href="#"><i class="fa fa-user-o"></i> Login</a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <form class="form-inline login-form" id="loginForm" action="<?php echo URL; ?>Login/logueo" method="post" onsubmit="return validar_formulario()">
                ...
                <div class="sl-slider">
                    ...
                    <div class="sl-slide item1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                        <div class="sl-slide-inner">
                            <div class="container">
                                <img class="pull-right" src="<?php echo URL; ?>img/sample/slider/img1.png" alt="" />
                                <h2>Bienvenidos a Visual Solutions</h2>
                                <h3 class="gap"></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sl-slide item2" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
                        <div class="sl-slide-inner">
                            <div class="container">
                                <img class="pull-right" src="<?php echo URL; ?>img/sample/slider/personas_gafas.jpg" alt="" />
                                <h2>Lentes servicios y accesorios</h2>
                                <h3 class="gap">Con la mejor calidad</h3>
                    ...
                    <div class="sl-slide item3" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
                        <div class="sl-slide-inner">
                            <div class="container">
                                <img class="pull-right" src="<?php echo URL; ?>img/sample/slider/gafas_ciudad.png" alt="" />
                                <h2>La mejor eleccion para tu salud visual</h2>
                                <h3 class="gap">Dejanos darte el mejor</h3
                            </div>
                        </div>
                    </div>
                    <!--Slider Item3-->
        ...
        <script src="<?php echo URL; ?>js/vendor/jquery-1.9.1.min.js"></script>
