...
<br>
  <table class="table table-hover">
      ...
      <?php foreach ($com as $compra):?>
          <tr>
              <td><?php if (isset($compra->id_compra)) echo htmlspecialchars($compra->id_compra, ENT_QUOTES, 'UTF-8'); ?></td>
              ...
              <td><a class="btn btn-success" href="<?php echo URL . 'compras/editar/' . htmlspecialchars($compra->id_compra, ENT_QUOTES, 'UTF-8'); ?>"><i class="mdi mdi-lead-pencil"></i></a></td>
              <td><a class="btn btn-danger" href="<?php echo URL . 'compras/eliminar/' . htmlspecialchars($compra->id_compra, ENT_QUOTES, 'UTF-8'); ?>"><i class="mdi mdi-delete"></i></a></td>
          </tr>
        <?php endForeach ?>
      </tbody>
  </table>
