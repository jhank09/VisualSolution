      ...
      <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
          <ul id="sidebarnav" class="p-t-30">
            ...
            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo URL;?>plansepare" aria-expanded="false"><i class="mdi mdi-book-open"></i><span class="hide-menu">Plan Separe</span></a></li>
