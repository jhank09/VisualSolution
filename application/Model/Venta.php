...
class Venta extends Model
{
    ...
    {
        $sql = "SELECT v.*, c.nombre_cliente, u.correo FROM ventas v INNER JOIN clientes c ON (v.id_cliente = c.id_cliente) INNER JOIN usuarios u ON (v.id_usuario = u.id_usuario)";
